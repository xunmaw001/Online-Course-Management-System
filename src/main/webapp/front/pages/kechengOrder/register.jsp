              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">金额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="moeny" id="moeny"  lay-verify="double|required"   placeholder="金额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
