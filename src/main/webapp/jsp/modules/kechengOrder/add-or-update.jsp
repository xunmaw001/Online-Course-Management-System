    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑课程订单</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">课程订单管理</li>
                        <li class="breadcrumb-item active">编辑课程订单</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">课程订单信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>课程价钱</label>
                                        <input id="kechengMoeny" name="kechengMoeny" class="form-control"
                                               placeholder="课程价钱" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>课程类型</label>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>金额</label>
                                        <input id="moeny" name="moeny" class="form-control"
                                               onchange="moenyChickValue(this)" placeholder="金额">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("kechengOrder/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addkechengOrder');
    ...
    // 获取当前详情
    function getDetails() {
        var addkechengOrder = window.sessionStorage.getItem("addkechengOrder");
        if (addkechengOrder != null && addkechengOrder != "" && addkechengOrder != "null") {
            window.sessionStorage.removeItem('addkechengOrder');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("kechengOrder/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function kechengDataBind(){
        ...
        $("#kechengMoeny").val(ruleForm.kechengMoeny);
