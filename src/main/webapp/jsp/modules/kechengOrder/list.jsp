        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">课程订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">课程订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">课程订单列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(kechengPhotoCell);
                    ...
                    //课程价钱
            var kechengMoenyCell = document.createElement('td');
            kechengMoenyCell.innerHTML = item.kechengMoeny;
            row.appendChild(kechengMoenyCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("kechengOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addkechengOrder", "addkechengOrder");
            window.location.href = "add-or-update.jsp"
        }
